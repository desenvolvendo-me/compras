builder resource, json do
  ...
  json.purchase_solicitations resource.purchase_solicitations do |json, purchase_solicitation|
    ...
    json.budget_allocations purchase_solicitation.purchase_solicitation_budget_allocations do |json, ps_budget_allocation|
      ...
      json.items ps_budget_allocation.items do |json, item|
        json.id                    item.id
