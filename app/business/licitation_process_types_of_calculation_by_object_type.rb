class LicitationProcessTypesOfCalculationByObjectType
  ...
  def initialize(type_of_calculation = LicitationProcessTypeOfCalculation, object_type = AdministrativeProcessObjectType)
  ...
  def correct_type_of_calculation?(object_type, type_of_calculation, object_types = AdministrativeProcessObjectType)
