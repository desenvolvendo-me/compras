class LicitationProcess < Compras::Model
  ...
  attr_accessible :payment_method_id, :type_of_purchase,
                  ...
                  :legal_analysis_appraisals_attributes, :publications_attributes, :bidders_attributes,
                  :purchase_process_accreditation_attributes
  ...
  accepts_nested_attributes_for :purchase_process_budget_allocations, :items, :creditor_proposals,
                                ...
                                :publications, :bidders, :purchase_process_accreditation, allow_destroy: true
