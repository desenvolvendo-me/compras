...
describe TceExport::MG::MonthlyMonitoring::PurchaseOpeningGenerator do
  describe "#generate_file" do
    ...
    it "generates a CSV file with the required data" do
      ...
      expect(csv).to eq "10;98; ;2013;2;3;1;1;20032013;20032013; ;20042012;Internet; ; ;20052013;2;2;Licitação para compra de carteiras; ; ; ;2;12;Dinheiro;Por Item com Melhor Técnica;2\n" +
                        "11;98; ;2013;2;2050;#{item.id};20032013;01.01.00001 - Antivirus;10,0000;2,0000;UN;000\n" +
                        "13;98; ;2013;2;98;98029;04;01;003;003; ;319001;001;50080"
    end
  end
end
