...
describe PurchaseSolicitationItemGroup do
  describe '#purchase_solicitation_status' do
    ...
    it "should not allow group annulled purchase solicitation" do
      ...
      expect(subject.errors[:purchase_solicitations]).to include "a solicitação de compras (1/2013 1 - Secretaria de Educação - RESP: Gabriel Sobrinho) não está liberada ou parcialmente atendida."
    end
    ...
    it "should allow group liberated purchase solicitation" do
      ...
      expect(subject.errors[:purchase_solicitations]).to_not include "a solicitação de compras (1/2013 1 - Secretaria de Educação - RESP: Gabriel Sobrinho) não está liberada ou parcialmente atendida."
    end
