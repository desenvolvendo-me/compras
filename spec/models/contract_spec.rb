...
describe Contract do
  ...
  xit { should validate_presence_of :sequential_number }
  ...
  xit { should validate_presence_of :budget_structure_id }
  xit { should validate_presence_of :budget_structure_responsible }
  ...
  describe '#allow_termination?' do
    xit 'should return true when contract_termination is not present' do
