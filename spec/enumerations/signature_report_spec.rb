...
describe SignatureReport do
  it 'should return availables' do
    ...
    described_class.availables.should eq [["Certificados de Registro Cadastral", "registration_cadastral_certificates"], ["Processos Administrativos", "administrative_processes"]]
  end

  it 'should return availables_keys' do
    described_class.stub(:unavailables_keys).and_return(['supply_authorizations'])
    described_class.availables_keys.should eq ['administrative_processes', 'registration_cadastral_certificates']
  end
