...
describe MapOfProposal do
  ...
  let :proposal_one do
    double('PurchaseProcessCreditorProposal', item_id: 1, unit_price: 5.99, creditor: bidder_one, creditor_benefited: false)
  end

  let :proposal_two do
    double('PurchaseProcessCreditorProposal', item_id: 1, unit_price: 4.99, creditor: bidder_two, creditor_benefited: true)
  end
