...
describe AdministrativeProcessModalitiesByObjectType do
  it 'should verify status for type' do
    subject.verify_modality(AdministrativeProcessObjectType::PURCHASE_AND_SERVICES, AdministrativeProcessModality::MAKING_COST_FOR_CONSTRUCTIONS_AND_ENGINEERING_SERVICES).should be_true
    ...
    subject.verify_modality(AdministrativeProcessObjectType::PURCHASE_AND_SERVICES, AdministrativeProcessModality::INVITATION_FOR_PURCHASES_AND_ENGINEERING_SERVICES).should be_true
