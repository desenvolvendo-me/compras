...
describe LicitationProcessTypesOfCalculationByObjectType do
  it 'should verify the content of types_of_calculations by judgment_kind' do
    expect(subject.types_of_calculation_groups[LicitationProcessObjectType::DISPOSALS_OF_ASSETS]).to eq(
  ...
  it 'should verify if type_of_calculation is included in group' do
    expect(subject.correct_type_of_calculation?(LicitationProcessObjectType::DISPOSALS_OF_ASSETS,
    ...
    expect(subject.correct_type_of_calculation?(LicitationProcessObjectType::CALL_NOTICE,
