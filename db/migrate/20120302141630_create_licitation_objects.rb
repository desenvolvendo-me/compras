class CreateLicitationObjects < ActiveRecord::Migration
  def change
    create_table :licitation_objects do |t|
      t.string :description
      t.integer :year
      t.decimal :purchase_licitation_exemption, :precision => 10, :scale => 2
      ...
      t.decimal :build_licitation_exemption, :precision => 10, :scale => 2
